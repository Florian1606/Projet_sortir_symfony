...
function searchVille(ville) {
    ...
    let sorties = getTabSortiesNotHidden();
    console.log("sortie :" + sorties);
    console.log("ville : " + sorties_ville);
    for (i = 0; i < sorties.length; i++) {
        // console.log("ville sortie : " + sorties_ville[i].value);
        // console.log("ville select : " + ville);
        if (sorties_ville[i].value !== ville) {
            // On cache la sortie
