...
class MainController extends AbstractController
{
     ...
     */
    public function modifier(VilleRepository $repo, FileUploader $fileUploader, Request $request, EntityManagerInterface $em, ParticipantRepository $repo, UserPasswordHasherInterface $userPasswordHasherInterface, $id): Response
    {
