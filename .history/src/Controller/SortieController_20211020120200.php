...
class SortieController extends AbstractController
{
    ...
    public function addSortie(EntityManagerInterface $em, Request $request, EtatRepository $etat, ValidatorInterface $validator): Response
    {
        ...
        $dateDebut = strtotime($request->request->get("dateDebut"));
        $dateLimiteInscription = strtotime($request->request->get("dateLimiteInscription"));
        $msg_error = [];
        dump(strtotime($dateDebut) > $dateNow);
        if ($dateDebut != null) {
