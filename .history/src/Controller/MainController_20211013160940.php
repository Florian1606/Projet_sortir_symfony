...
class MainController extends AbstractController
{
    ...
    public function search(Request $request, SortieRepository $sortieRepo, SiteRepository $siteRepo, $id): Response
    {
        ...
        if ($search != "" && $isSortiesOrganisateur == null && $isSortiesInscrit == null && $isSortiesNonInscrit == null && $isSortiesPassees == null) {
            dump("OOOK");
        ...
        if ($isSortiesOrganisateur != null) {
            $sorties = array_merge($sorties,$sortieRepo->findByIdOrganisateur($idCurrentUser, $idSite));
        }
