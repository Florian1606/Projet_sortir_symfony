...
class MainController extends AbstractController
{
     ...
     */
    public function index(Request $request, SortieRepository $sortieRepo, SiteRepository $siteRepo, Security $security): Response
    {
        ...
        $sorties = $sortieRepo->findSearch($form, $idCurrentUser);
