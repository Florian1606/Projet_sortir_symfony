...
class MainController extends AbstractController
{
     ...
     */
    public function modifier(VilleRepository $repoV, FileUploader $fileUploader, Request $request, EntityManagerInterface $em, ParticipantRepository $repo, UserPasswordHasherInterface $userPasswordHasherInterface, $id): Response
    {
        $participant = $repo->find(1);
        $ville = $repoV->find(1);
        dd($ville);
        // instanciation de la classe produit
        $participant = $repo->find($id);
