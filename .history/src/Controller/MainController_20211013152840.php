...
class MainController extends AbstractController
{
     ...
     */
    public function search(Request $request, SortieRepository $sortieRepo, SiteRepository $siteRepo): Response
    {
        ...
        $dateLimiteInscription = $request->request->get('isSortiesOrganisateur');
        $isSortiesOrganisateur = $request->request->get('isSortiesInscrit');
        $isSortiesNonInscrit = $request->request->get('isSortiesPasInscrit');
        $isSortiesPassees =  $request->request->get('isSortiesPassees');
        $idCurrentUser = 1;
        $idSite = $request->request->get('isSortiesPassees');;
